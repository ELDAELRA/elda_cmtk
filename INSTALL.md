...
-   Install OCaml-specific dependencies:
    ...
    -   `xml-light` is needed by the `crawler_reporter` tool for reading and parsing the XML TMX files produced by the [ILSP-FC](http://nlp.ilsp.gr/redmine/projects/ilsp-fc) crawler.
